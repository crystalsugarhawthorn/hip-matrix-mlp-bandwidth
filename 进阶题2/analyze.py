...
# 读取 CSV 文件
kernel_data = pd.read_csv("d:\\南开\\南开\\计算机组成原理\\先导杯\\进阶题2\\kernel.csv")
hiptrace_data = pd.read_csv("d:\\南开\\南开\\计算机组成原理\\先导杯\\进阶题2\\hiptrace.csv")
...
plt.savefig("d:\\南开\\南开\\计算机组成原理\\先导杯\\进阶题2\\execution_analysis_combined.png", dpi=300)
plt.show()
